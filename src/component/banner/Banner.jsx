    ...
    return (
        <div className="hero min-h-[500px] bg-[rgb(20,69,47)] text-white">
            <div className="hero-content  relative p-0">
                <div className="max-w-full text-center md:flex justify-between items-center h-fit md:h-[500px]  mx-auto">
                    ...
                    <div data-aos="zoom-in" className="flex-grow ">
                        <div className=" min-h-[300px] max-h-fit pb-8 md:pb-0 mt-[10%]">
                            ...
                            <p className="py-6 text-lg md:text-xl text-wrap   px-3 md:px-0">
